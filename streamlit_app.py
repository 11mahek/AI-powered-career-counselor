...
# Step 1: Generate quiz
    ...
    prompt = (
        f"Generate 3 multiple-choice questions for a person who completely confused in his life and person age is {st.session_state.age}"
...
# Step 3: Completion
    ...
    if st.button("Career"):
        prompt = (
            ...
            "Show market trend, reason, required skill on different line, not like paragrgh"
        )
